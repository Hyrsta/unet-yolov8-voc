...
from yolov8_nets.yolo import YoloBody
from yolov8_utils.utils import (cvtColor, get_classes, preprocess_input,
                         resize_image, show_config)
from yolov8_utils.utils_bbox import DecodeBox
...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'yolov8_model_data/yolov8_custom_model.pth',
        "classes_path"      : 'yolov8_model_data/voc_classes.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='yolov8_model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
